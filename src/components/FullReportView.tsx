        ...
        <div className="space-y-6">
          {(() => {
            const catMap: Record<string, { title: string; data: any }> = {
              website_clarity: { title: "Business & Website Clarity", data: categories.websiteClarity },
              search_local: { title: "Search & Local Presence", data: categories.searchLocal },
              content_authority: { title: "Content & Authority", data: categories.contentAuthority },
